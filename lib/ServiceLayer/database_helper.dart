...
class DatabaseHelper {
  ...
  static const columnDateOfBirth = 'dob';
  static const columnNationality = 'nationality';
  static const columnGender = 'gender';
  static const columnPictures = 'pictures';
  ...
  Future<List<Map<String, dynamic>>> queryAllRows() async {
   ...
   Future<Map<String, dynamic>> queryRow(int id) async {
    Database db = await instance.database;
    List<Map<String,dynamic>> res = await db.query(table,where: '$columnId = ?',whereArgs: [id]);
    return res.first;
  }
